...
///
///   File: PluginSignals.hpp
///
/// Author: $author$
///   Date: 11/1/2022
///////////////////////////////////////////////////////////////////////
#ifndef ULUCIDITY_UI_PLUGINSIGNALS_HPP
#define ULUCIDITY_UI_PLUGINSIGNALS_HPP
...
typedef GraphicSurface::GraphicContext GraphicContext;

typedef ImplementBase PluginSignalsImplements;
///////////////////////////////////////////////////////////////////////
///  Class: PluginSignals
///////////////////////////////////////////////////////////////////////
class _EXPORT_CLASS PluginSignals: virtual public PluginSignalsImplements {
public:
    ...
    ///////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////
    virtual bool onFailedLoadInage() {
        PluginSignals* to = ForwardPluginSignalsTo();
        if ((to)) {
            //LOG_DEBUG("return to->onFailedLoadInage()...");
            return to->onFailedLoadInage();
        }
        //LOG_DEBUG("return false...");
        return true;
    }
...
#endif // ULUCIDITY_UI_PLUGINSIGNALS_HPP 
